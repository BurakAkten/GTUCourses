...
begin:
   read a value to B register
  MVI A, READ_B	; store the OS call code to A
  call GTU_OS	; call the OS
  ;print the value of the reg B on the screen
  MVI A, PRINT_B	; store the OS call code to A
  call GTU_OS	; call the OS

  ;;read an integer to the BC memory address
  MVI A, READ_MEM	; store the OS call code to A
  call GTU_OS	; call the OS
  ;print the value that is on the BC address on screen
